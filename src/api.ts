 ...
 * Public API interface for Insania et Perturbatio Animi module
...
export interface InsaniaEtPerturbatioAnimiAPI {
  application: InsaniaEtPerturbatioAnimiApplication;
  eventBus: EventBus;
...
export function registerAPI(components: {
  ...
  (globalThis as any).InsaniaEtPerturbatioAnimi = api;
  logger.info('API registered globally as InsaniaEtPerturbatioAnimi');
}