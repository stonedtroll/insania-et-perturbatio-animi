...
export class KeyboardHandler {
   ...
   */
   registerKeybindings(): void {
    ...
    try {
      // Register M key for anguish overlays
      game.keybindings.register(MODULE_ID, 'toggleAnguishOverlay', {
        name: `${MODULE_ID}.keybindings.toggleAnguishOverlay.name`,
        hint: `${MODULE_ID}.keybindings.toggleAnguishOverlay.hint`,
        editable: [{
          key: 'KeyM',
          modifiers: []
        }],
