...
import type {
  ...
  FoundryCharacterSheetClosedEvent
...
export interface EventMap {
  ...
  'characterSheet:render': FoundryCharacterSheetOpenedEvent;
  'characterSheet:close': FoundryCharacterSheetClosedEvent;
  ...
  // Anguish events
  'anguish.changed': AnguishChangedEvent;

  // Character sheet events
  'characterSheet.opened': CharacterSheetOpenedEvent;
