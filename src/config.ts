export const MODULE_ID = 'insania-et-perturbatio-animi';
export const MODULE_NAME = 'Insania et Perturbatio Animi';
export const MODULE_ABBR = 'IEPA';
...
/**
 * Anguish arc overlay configuration
 */
export const ANGUISH_ARC_CONFIG = {
    colours: {
        background: '#222222',
        low: '#2C2F33',
        mid: '#581E1F',
